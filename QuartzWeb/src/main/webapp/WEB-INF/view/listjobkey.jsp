	...
	<div id="middle">
		...
		<div id="center-column">
		  ...
		  <div class="table">
				...
				<form action="addordertask" method="post">
				<table class="listing form" cellpadding="0" cellspacing="0">
					...
					<tr class="bg">
						<td class="first" width="100"><strong>任务名称:</strong>${job}</td>
						<td class="last"><input type="hidden" value="${job}" name = "jobkey"/>顺序：<input type="text" class="text" id="joborder" name="joborder" value=""/></td>
					</tr>
					</c:forEach>
					<tr>

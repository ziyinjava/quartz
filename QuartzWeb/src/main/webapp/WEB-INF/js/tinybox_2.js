	...
	return{
		...
		psh:function(c,w,h,a){
			if(a){
                ...
                hide:function(area1,area2){
                       if(area1 && area2){
                        var value1 = document.getElementById(area1).value;
			var value2 = document.getElementById(area2).value;
 			document.getElementById(area1).value=value2;
                        }
		...
		pos:function(){
			...
			if(window.ActiveXObject){ // IE
				p.style.top=(t+TINY.page.top())+50 + 'px';
				p.style.left=(TINY.page.width()/2)-(p.offsetWidth/2) + 650 +'px';
			}else{ // 其他浏览器
